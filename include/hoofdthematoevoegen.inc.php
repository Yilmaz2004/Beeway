...
<div class="addedit">
    <form class="form" action="#" method="POST">
      ...
      <div id="LP">
        ...
        <input id="textaddedit" type="text" placeholder="NaamThemaP1" name="NaamThemaP1" required>
        <label for="NaamThemaP2"><b>Hoofdthema naam Periode 2</b></label>
        <input id="textaddedit" type="text" placeholder="NaamThemaP2" name="NaamThemaP2" required>
        <label for="NaamThemaP3"><b>Hoofdthema naam Periode 3</b></label>
        <input id="textaddedit" type="text" placeholder="NaamThemaP3" name="NaamThemaP3" required>
      </div>
      <div id="RP">
        <label for="NaamThemaP4"><b>Hoofdthema naam Periode 4</b></label>
        <input id="textaddedit" type="text" placeholder="NaamThemaP4" name="NaamThemaP4" required>
        <label for="NaamThemaP5"><b>Hoofdthema naam Periode 5</b></label>
        <input id="textaddedit" type="text" placeholder="NaamThemaP5" name="NaamThemaP5" required>

        <label for="Schooljaar"><b>Schooljaar</b></label>
        <select id="selectaddedit" name="Schooljaar" >
